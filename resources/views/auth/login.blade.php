		...
		<div class="container-login100">
			<div class="wrap-login100">
				<div class="login100-pic js-tilt" data-tilt>
                    <img src="csslogin/images/img-05.png" alt="IMG">
                ...
                <span class="login100-form-title">
                    ...
                    <input class="input100" type="text" name="email" placeholder="Email" name="email" value="{{ old('email') }}">
